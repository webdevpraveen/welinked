...
class PartnerStatusCard extends StatelessWidget {
  ...
  const PartnerStatusCard({super.key, this.partner});
          ...
          children: [
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: isOnline ? const Color(0xFF43A047) : const Color(0xFF9E9E9E),
                              shape: BoxShape.circle,
                            ),
                          ),
                          const SizedBox(width: 6),
                          Text(
                            isOnline ? 'Online' : 'Offline (Last seen: $lastSeenStr)',
            ...
            Row(
              ...
              children: [
                ...
                _StatusItem(
                  icon: partner!.gpsEnabled ? Icons.gps_fixed_rounded : Icons.gps_off_rounded,
                  iconColor: partner!.gpsEnabled ? const Color(0xFF1E88E5) : const Color(0xFFE53935),
                ...
                _StatusItem(
                  ...
                  value: partner!.internetConnected ? 'Connected' : 'Offline',
                  label: 'Internet',
                ),
              ],
            ),
